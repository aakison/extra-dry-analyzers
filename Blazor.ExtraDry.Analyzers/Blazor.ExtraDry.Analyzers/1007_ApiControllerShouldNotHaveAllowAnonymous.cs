...
namespace Blazor.ExtraDry.Analyzers {
    ...
    public class ApiControllerShouldNotHaveAllowAnonymous : DryDiagnosticNodeAnalyzer {
        ...
        public ApiControllerShouldNotHaveAllowAnonymous() : base(
            ...
            "Security should be considered at each individual endpoint.  Providing AllowAnonymous on the class can uintentionally allow new endpoints to have the wrong security policy.  Apply either AllowAnonymous or Authorize on each endpoint."
            )
        { }
